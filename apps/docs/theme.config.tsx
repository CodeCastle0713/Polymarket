...
const template = siteTemplate({
  ...
  contentFooter: {
    editRepositoryBase: 'https://github.com/Polymarket',
    socials: [
      social.discord('https://discord.com/invite/polymarket'),
      social.github('https://github.com/Polymarket'),
    ],
  },
  meta: {
...
const starLinks = [
  link('GitHub', 'https://github.com/Polymarket', {
    style: 'star',
    newTab: true,
    icon: 'akar-icons:github-fill',
  }),
  link('Discord', 'https://discord.com/invite/polymarket', {
    style: 'star',
    newTab: true,
    icon: 'fa6-brands:discord',
  }),
  link('Suggest features', 'https://github.com/Polymarket', {
    style: 'star',
    newTab: true,
